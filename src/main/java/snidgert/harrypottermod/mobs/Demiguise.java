...
public class Demiguise extends ModelBase {
	...
	public Demiguise() {
		...
		(this.Arm2L = new ModelRenderer(this, 26, 21)).addBox(-1.0f, 3.5f, -1.3f, 2, 4, 2);
		this.Arm2L.setRotationPoint(2.5f, 16.5f, -1.5f);
		this.Arm2L.setTextureSize(64, 32);
		this.setRotation(this.Arm2L, 0.0f, 0.0f, 0.0f);
		(this.Arm2R = new ModelRenderer(this, 26, 21)).addBox(-1.0f, 3.5f, -1.3f, 2, 4, 2);
		this.Arm2R.setRotationPoint(-2.5f, 16.5f, -1.5f);
		...
		this.EarL.setRotationPoint(2.0f, 12.5f, -3.0f);
		...
		this.EarR.setRotationPoint(-2.0f, 12.5f, -3.0f);
