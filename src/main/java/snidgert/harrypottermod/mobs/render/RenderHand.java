...
import snidgert.harrypottermod.mobs.Hand;

public class RenderHand extends TileEntitySpecialRenderer {
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderHand.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/Hand.png");
	}
}
