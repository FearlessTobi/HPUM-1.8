...
public class RenderImperioStrongProjectile extends Render {

	private static final ResourceLocation texture;
	private ModelBase model;

	public RenderImperioStrongProjectile(final RenderManager renderManager) {
		super(renderManager);
	...
	private ResourceLocation getCustomTexture(final ImperioProjectile entity) {
		return RenderImperioStrongProjectile.texture;
	}
	...
	public void doRender(final Entity entity, final double x, final double y, final double z, final float yaw, final float partialTick) {
		GL11.glPushMatrix();
		this.bindTexture(RenderImperioStrongProjectile.texture);
