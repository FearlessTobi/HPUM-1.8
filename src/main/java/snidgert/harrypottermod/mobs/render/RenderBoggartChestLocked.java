...
import snidgert.harrypottermod.mobs.BoggartChestLocked;

public class RenderBoggartChestLocked extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private BoggartChestLocked model;

	public RenderBoggartChestLocked() {
		this.model = new BoggartChestLocked();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderBoggartChestLocked.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/BoggartChest.png");
	}
}
