...
import snidgert.harrypottermod.mobs.BoggartChestOpen;

public class RenderBoggartChestOpen extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private BoggartChestOpen model;

	public RenderBoggartChestOpen() {
		this.model = new BoggartChestOpen();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderBoggartChestOpen.EntityTexture);
		GL11.glPushMatrix();
