...
import snidgert.harrypottermod.mobs.Cup;

public class RenderCup extends TileEntitySpecialRenderer {
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderCup.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/Cup.png");
	}
}
