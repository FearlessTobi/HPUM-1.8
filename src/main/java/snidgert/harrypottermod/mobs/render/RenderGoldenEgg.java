...
import snidgert.harrypottermod.mobs.GoldenEgg;

public class RenderGoldenEgg extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private GoldenEgg model;

	public RenderGoldenEgg() {
		this.model = new GoldenEgg();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderGoldenEgg.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/GoldenEgg.png");
	}
}
