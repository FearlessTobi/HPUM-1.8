...
import snidgert.harrypottermod.mobs.Locket;

public class RenderLocket extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private Locket model;

	public RenderLocket() {
		this.model = new Locket();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderLocket.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/Locket.png");
	}
}
