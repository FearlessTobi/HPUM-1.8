...
import snidgert.harrypottermod.mobs.WandCrafter;

public class RenderWandCrafter extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private WandCrafter model;

	public RenderWandCrafter() {
		this.model = new WandCrafter();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderWandCrafter.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/WandCrafter.png");
	}
}
