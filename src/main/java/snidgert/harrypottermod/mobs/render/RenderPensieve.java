...
import snidgert.harrypottermod.mobs.Pensieve;

public class RenderPensieve extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private Pensieve model;

	public RenderPensieve() {
		this.model = new Pensieve();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderPensieve.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/Pensieve.png");
	}
}
