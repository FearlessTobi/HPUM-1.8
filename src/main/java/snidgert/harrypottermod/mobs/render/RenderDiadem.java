...
import snidgert.harrypottermod.mobs.Diadem;

public class RenderDiadem extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private Diadem model;

	public RenderDiadem() {
		this.model = new Diadem();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderDiadem.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/Diadem.png");
	}
