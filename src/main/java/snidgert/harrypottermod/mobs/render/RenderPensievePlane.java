...
import snidgert.harrypottermod.mobs.PensievePlane;

public class RenderPensievePlane extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private PensievePlane model;

	public RenderPensievePlane() {
		this.model = new PensievePlane();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderPensievePlane.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/PensievePlane.png");
	}
}
