...
public class RenderStunProjectile extends Render {

	private static final ResourceLocation texture;
	private ModelBase model;

	public RenderStunProjectile(final RenderManager renderManager) {
		super(renderManager);
	...
	private ResourceLocation getCustomTexture(final StunProjectile entity) {
		return RenderStunProjectile.texture;
	}
	...
	public void doRender(final Entity entity, final double x, final double y, final double z, final float yaw, final float partialTick) {
		GL11.glPushMatrix();
		this.bindTexture(RenderStunProjectile.texture);
