...
import snidgert.harrypottermod.mobs.TriCup;

public class RenderTriCup extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private TriCup model;

	public RenderTriCup() {
		this.model = new TriCup();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderTriCup.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/TriCup.png");
	}
}
