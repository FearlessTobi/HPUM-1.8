...
import snidgert.harrypottermod.mobs.StoneSoldierBlock;

public class RenderStoneSoldierBlock extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private StoneSoldierBlock model;

	public RenderStoneSoldierBlock() {
		this.model = new StoneSoldierBlock();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderStoneSoldierBlock.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/StoneSoldierBlock.png");
	}
}
