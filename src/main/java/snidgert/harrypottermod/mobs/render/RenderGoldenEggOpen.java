...
import snidgert.harrypottermod.mobs.GoldenEggOpen;

public class RenderGoldenEggOpen extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private GoldenEggOpen model;

	public RenderGoldenEggOpen() {
		this.model = new GoldenEggOpen();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderGoldenEggOpen.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/GoldenEggOpen.png");
	}
}
