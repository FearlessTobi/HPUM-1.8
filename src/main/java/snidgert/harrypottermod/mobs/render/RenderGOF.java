...
import snidgert.harrypottermod.mobs.GOF;

public class RenderGOF extends TileEntitySpecialRenderer {
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderGOF.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/GOF.png");
	}
}
