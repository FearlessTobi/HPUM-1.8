...
import snidgert.harrypottermod.mobs.Crystalball;

public class RenderCrystalball extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private Crystalball model;

	public RenderCrystalball() {
		this.model = new Crystalball();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderCrystalball.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/Crystalball.png");
	}
}
