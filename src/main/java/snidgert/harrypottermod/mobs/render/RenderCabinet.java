...
import snidgert.harrypottermod.mobs.Cabinet;
...
public class RenderCabinet extends TileEntitySpecialRenderer {
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderCabinet.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/Cabinet.png");
	}
}
