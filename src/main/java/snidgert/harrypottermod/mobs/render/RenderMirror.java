...
import snidgert.harrypottermod.mobs.Mirror;

public class RenderMirror extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private Mirror model;

	public RenderMirror() {
		this.model = new Mirror();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderMirror.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/Mirror.png");
	}
}
