...
public class RenderConfringoStrongProjectile extends Render {

	private static final ResourceLocation texture;
	private ModelBase model;

	public RenderConfringoStrongProjectile(final RenderManager renderManager) {
		super(renderManager);
	...
	private ResourceLocation getCustomTexture(final ConfringoProjectile entity) {
		return RenderConfringoStrongProjectile.texture;
	}
	...
	public void doRender(final Entity entity, final double x, final double y, final double z, final float yaw, final float partialTick) {
		GL11.glPushMatrix();
		this.bindTexture(RenderConfringoStrongProjectile.texture);
