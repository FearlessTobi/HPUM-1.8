...
import snidgert.harrypottermod.mobs.beans;

public class RenderEveryFlavourBeans extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private beans model;

	public RenderEveryFlavourBeans() {
		this.model = new beans();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderEveryFlavourBeans.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/beans.png");
	}
}
