...
import snidgert.harrypottermod.mobs.Diary;

public class RenderDiary extends TileEntitySpecialRenderer {
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderDiary.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/Diary.png");
	}
}
