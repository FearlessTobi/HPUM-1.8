...
import snidgert.harrypottermod.mobs.DarkMark;

public class RenderDarkMark extends TileEntitySpecialRenderer {

	private static final ResourceLocation EntityTexture;
	private DarkMark model;

	public RenderDarkMark() {
		this.model = new DarkMark();
	}
	...
	public void renderAModelAt(final TileEntity tileentity, final double d, final double d1, final double d2, final float f) {
		...
		this.bindTexture(RenderDarkMark.EntityTexture);
		GL11.glPushMatrix();
	...
	static {
		EntityTexture = new ResourceLocation("harrypottermod:textures/mobs/DarkMark.png");
	}
}
