...
public class EntityGhost extends EntityWolfBase { //DONE: Refactoring
	...
	public EntityGhost(final World par1World, final double par2, final double par4, final double par6) {
		this(par1World);
	...
	public EntityGhost spawnBabyAnimal(final EntityAgeable par1EntityAgeable) {
		final EntityGhost entitywolf = new EntityGhost(worldObj);
	...
	public boolean shouldAttackEntity(final EntityLivingBase par1EntityLivingBase, final EntityLivingBase par2EntityLivingBase) {
		if (!(par1EntityLivingBase instanceof EntityCreeper) && !(par1EntityLivingBase instanceof EntityGhast)) {
			if (par1EntityLivingBase instanceof EntityGhost) {
				final EntityGhost entitywolf = (EntityGhost) par1EntityLivingBase;
			}
