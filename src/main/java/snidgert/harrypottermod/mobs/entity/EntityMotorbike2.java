...
public class EntityMotorbike2 extends EntityHorse { //DONE: Refactoring
	...
	public EntityMotorbike2(final World par1World) {
		super(par1World);
	...
	public EntityMotorbike2(final World par1World, final double par2, final double par4, final double par6) {
		this(par1World);
	...
	public void onUpdate() {
		...
		if (this.riddenByEntity != null) {
			if (this.FireBreath) {
				super.moveFlying(((EntityLivingBase) this.riddenByEntity).moveStrafing * 0.5f, ((EntityLivingBase) this.riddenByEntity).moveForward, 0.3f);
			}
			if (this.FlyUp) {
				this.motionY += 0.4;
	...
	public void moveEntityWithHeading(float par1, float par2) {
		if (this.riddenByEntity != null) {
			...
			if (!this.onGround) {
				super.moveFlying(par1, par2, 0.2f);
