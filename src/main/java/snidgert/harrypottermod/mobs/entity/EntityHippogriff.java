...
public class EntityHippogriff extends EntityHorse {
	...
	public EntityHippogriff(final World par1World) {
		super(par1World);
	...
	protected Item func_146068_u() {
		return MainClass.HippogriffFeather;
	}
	...
	protected String getLivingSound() {
		return "harrypottermod:Hippogriff1";
	}

	@Override
	protected String getDeathSound() {
		return "harrypottermod:Hippogriff2";
	}
