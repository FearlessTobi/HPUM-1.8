...
public class EntityPhoenix extends EntityGolem {
	...
	protected Item func_146068_u() {
		return MainClass.PhoenixFeather;
	}
	...
	public boolean isBurning() {
		final List list1 = this.worldObj.getEntitiesWithinAABB(EntityLiving.class, new AxisAlignedBB(this.posX, this.posY, this.posZ, this.posX + 1.0, this.posY + 1.0, this.posZ + 1.0).expand(10.0, 10.0, 10.0));
	...
	public void onLivingUpdate() {
		...
		if (!this.worldObj.isRemote && --this.timeUntilNextEgg <= 0) {
			...
			this.dropItem(MainClass.PhoenixFeather, 1);
			this.timeUntilNextEgg = this.rand.nextInt(6000) + 6000;
		}
	}
