...
public class EntityKelpie extends EntityMob implements IMob { //DONE: Refactoring
	...
	public EntityKelpie(final World p_i1695_1_) {
		super(p_i1695_1_);
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		this.dropItem(MainClass.KelpieHair, 1);
	}
	...
	static class AIMoveRandom extends EntityAIBase {
		...
		private EntityKelpie kelpie;

		public AIMoveRandom(EntityKelpie p_i45859_1_) {
			this.kelpie = p_i45859_1_;
		}
		...
		public void updateTask() {
			int i = this.kelpie.getAge();

			if (i > 100) {
				this.kelpie.func_175568_b(0.0F, 0.0F, 0.0F);
			} else if (this.kelpie.getRNG().nextInt(50) == 0 || !this.kelpie.inWater || !this.kelpie.func_175567_n()) {
				float f = this.kelpie.getRNG().nextFloat() * (float) Math.PI * 2.0F;
				float f1 = MathHelper.cos(f) * 0.2F;
				float f2 = -0.1F + this.kelpie.getRNG().nextFloat() * 0.2F;
				float f3 = MathHelper.sin(f) * 0.2F;
				this.kelpie.func_175568_b(f1, f2, f3);
			}
		}
	}
