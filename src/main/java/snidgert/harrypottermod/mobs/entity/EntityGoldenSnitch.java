...
public class EntityGoldenSnitch extends EntityAmbientCreature {

	private BlockPos currentFlightTarget;

	public EntityGoldenSnitch(final World par1World) {
		super(par1World);
		this.setSize(0.5f, 0.9f);
		this.setIsBatHanging(true);
	}

	public EntityGoldenSnitch(final World par1World, final double par2, final double par4, final double par6) {
		this(par1World);
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(30.0);
	}
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		this.dropItem(MainClass.TheGoldenSnitch, 1);
	}

	@Override
	public boolean interact(final EntityPlayer par1EntityPlayer) {
		par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(MainClass.TheGoldenSnitch, 1));
		this.setDead();
		return true;
	}
}
