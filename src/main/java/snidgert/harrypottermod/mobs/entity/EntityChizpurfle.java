...
public class EntityChizpurfle extends EntityAnimal {

	private static final String __OBFID = "CL_00001647";

	public EntityChizpurfle(final World p_i1689_1_) {
		super(p_i1689_1_);
	...
	@Override
	public EntityChizpurfle createChild(final EntityAgeable p_90011_1_) {
		return null;
	}
}
