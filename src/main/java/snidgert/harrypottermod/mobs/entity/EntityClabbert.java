...
public class EntityClabbert extends EntityAnimal {

	private static final String __OBFID = "CL_00001647";

	public EntityClabbert(final World p_i1689_1_) {
		super(p_i1689_1_);
	...
	@Override
	public EntityClabbert createChild(final EntityAgeable p_90011_1_) {
		return null;
	}
}
