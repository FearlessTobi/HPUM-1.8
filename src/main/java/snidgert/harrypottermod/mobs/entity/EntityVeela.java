...
public class EntityVeela extends EntityWolf implements IRangedAttackMob {

	private int field_70846_g;
	private static ItemStack heldItem;

	public EntityVeela(final World par1World) {
		super(par1World);
	...
	public EntityVeela(final World par1World, final double par2, final double par4, final double par6) {
		this(par1World);
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		this.dropItem(MainClass.VeelaHair, 10);
	}
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase par1EntityLivingBase, final float par2) {
		...
		final ExpelliarmusProjectile entitysnowball = new ExpelliarmusProjectile(this.worldObj, this, d0 + this.rand.nextGaussian() * f1, d2, d3 + this.rand.nextGaussian() * f1);
	...
	public ItemStack getHeldItem() {
		return EntityVeela.heldItem;
	}

	static {
		EntityVeela.heldItem = new ItemStack(MainClass.DPSWandClass);
	}
}
