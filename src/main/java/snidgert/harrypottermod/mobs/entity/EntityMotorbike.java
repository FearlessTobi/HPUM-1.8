...
public class EntityMotorbike extends EntityHorse { //DONE: Refactoring
	...
	public EntityMotorbike(final World par1World) {
		super(par1World);
	...
	public EntityMotorbike(final World par1World, final double par2, final double par4, final double par6) {
		this(par1World);
