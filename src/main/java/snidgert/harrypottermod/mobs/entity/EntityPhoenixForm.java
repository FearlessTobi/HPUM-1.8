...
public class EntityPhoenixForm extends EntityHorse {
	...
	public EntityPhoenixForm(final World par1World) { //DONE: Refactoring
		super(par1World);
	...
	public void onUpdate() {
		...
		if (this.riddenByEntity != null) {
			if (this.FireBreath) {
				this.heal(60.0f);
				final List list1 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, new AxisAlignedBB(this.posX, this.posY, this.posZ, this.posX + 1.0, this.posY + 1.0, this.posZ + 1.0).expand(4.0, 4.0, 4.0));
