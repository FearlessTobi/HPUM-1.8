...
public class EntitySnidget extends EntityAmbientCreature {

	private BlockPos currentFlightTarget;

	public EntitySnidget(final World par1World) {
		super(par1World);
		this.setSize(0.5f, 0.9f);
		this.setIsBatHanging(true);
	}

	public EntitySnidget(final World par1World, final double par2, final double par4, final double par6) {
		this(par1World);
