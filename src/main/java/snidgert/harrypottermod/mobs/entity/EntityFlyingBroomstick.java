...
public class EntityFlyingBroomstick extends EntityHorse { //DONE: Refactoring
	...
	public EntityFlyingBroomstick(final World par1World) {
		super(par1World);
	...
	public EntityFlyingBroomstick(final World par1World, final double par2, final double par4, final double par6) {
		this(par1World);
	...
	public void onUpdate() {
		...
		if (this.riddenByEntity != null) {
			if (this.FireBreath) {
				super.moveFlying(((EntityLivingBase) this.riddenByEntity).moveStrafing * 0.05f, ((EntityLivingBase) this.riddenByEntity).moveForward, 0.03f);
			}
			if (this.FlyUp) {
				this.motionY += 0.15;
