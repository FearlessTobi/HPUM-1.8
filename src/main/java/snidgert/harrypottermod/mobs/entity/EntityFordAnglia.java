...
public class EntityFordAnglia extends EntityHorse { //DONE: Refactoring
	...
	public EntityFordAnglia(final World par1World) {
		super(par1World);
	...
	public EntityFordAnglia(final World par1World, final double par2, final double par4, final double par6) {
		this(par1World);
