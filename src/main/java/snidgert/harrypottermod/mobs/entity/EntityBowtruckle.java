...
public class EntityBowtruckle extends EntityAnimal {

	private static final String __OBFID = "CL_00001647";

	public EntityBowtruckle(final World p_i1689_1_) {
		super(p_i1689_1_);
	...
	@Override
	public EntityBowtruckle createChild(final EntityAgeable p_90011_1_) {
		return null;
	}
}
