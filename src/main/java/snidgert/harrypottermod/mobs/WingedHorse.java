...
public class WingedHorse extends ModelBase {
	...
	public WingedHorse() {
		...
		this.Leg1R.setRotationPoint(-4.0f, 16.0f, -10.1f);
		...
		this.Leg1L.setRotationPoint(4.0f, 16.0f, -10.1f);
		this.Leg1L.setTextureSize(128, 128);
		this.Leg1L.mirror = true;
		this.setRotation(this.Leg1L, 0.0f, 0.0f, 0.0f);
		(this.Leg2R = new ModelRenderer(this, 96, 43)).addBox(-1.5f, 0.0f, -1.5f, 3, 5, 3);
		...
		(this.Leg2L = new ModelRenderer(this, 78, 43)).addBox(-1.5f, 0.0f, -1.5f, 3, 5, 3);
		...
		(this.FeetR = new ModelRenderer(this, 96, 51)).addBox(-2.0f, 0.0f, -2.0f, 4, 3, 4);
		...
		(this.FeetL = new ModelRenderer(this, 78, 51)).addBox(-2.0f, 0.0f, -2.0f, 4, 3, 4);
		...
		this.Feet1L.setRotationPoint(4.0f, 21.0f, -10.1f);
		...
		this.Feet1R.setRotationPoint(-4.0f, 21.0f, -10.1f);
		...
		(this.WingL = new ModelRenderer(this, 0, 68)).addBox(0.0f, -1.0f, -1.0f, 16, 2, 2);
		this.WingL.setRotationPoint(5.0f, 6.0f, -8.0f);
		this.WingL.setTextureSize(128, 128);
		this.WingL.mirror = true;
		this.setRotation(this.WingL, 0.0f, 0.0f, 0.0f);
		(this.WingR = new ModelRenderer(this, 0, 68)).addBox(-15.0f, -1.0f, -1.0f, 15, 2, 2);
		this.WingR.setRotationPoint(-5.0f, 6.0f, -8.0f);
		this.WingR.setTextureSize(128, 128);
		this.WingR.mirror = true;
		this.setRotation(this.WingR, 0.0f, 0.0f, 0.0f);
		(this.Wing2L = new ModelRenderer(this, 0, 72)).addBox(0.0f, -0.5f, -7.5f, 15, 1, 15);
		this.Wing2L.setRotationPoint(5.0f, 6.0f, 0.0f);
		this.Wing2L.setTextureSize(128, 128);
		this.Wing2L.mirror = true;
		this.setRotation(this.Wing2L, 0.0f, 0.0f, 0.0f);
		(this.Wing2R = new ModelRenderer(this, 0, 72)).addBox(-15.0f, -0.5f, -7.5f, 15, 1, 15);
		this.Wing2R.setRotationPoint(-5.0f, 6.0f, 0.0f);
		this.Wing2R.setTextureSize(128, 128);
		this.Wing2R.mirror = true;
		this.setRotation(this.Wing2R, 0.0f, 0.0f, 0.0f);
	}
