...
public class BoggartChestLocked extends ModelBase {

	ModelRenderer Bottum;
	ModelRenderer Top;
	ModelRenderer Lock;

	public BoggartChestLocked() {
		...
		this.setRotation(this.Bottum, 0.0f, 0.0f, 0.0f);
		...
		(this.Lock = new ModelRenderer(this, 5, 63)).addBox(0.0f, 0.0f, 0.0f, 2, 4, 2);
		this.Lock.setRotationPoint(-1.0f, 10.0f, -10.0f);
		this.Lock.setTextureSize(128, 128);
		this.Lock.mirror = true;
		this.setRotation(this.Lock, 0.0f, 0.0f, 0.0f);
	}
