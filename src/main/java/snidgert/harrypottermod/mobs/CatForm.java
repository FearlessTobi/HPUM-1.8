...
public class CatForm extends ModelBase {
	...
	public CatForm() {
		...
		(this.Body = new ModelRenderer(this, 20, 0)).addBox(-2.0f, 0.0f, -3.0f, 4, 16, 6);
		this.Body.setRotationPoint(0.0f, 17.0f, 0.0f);
		this.Body.setTextureSize(64, 32);
		this.Body.mirror = true;
		this.setRotation(this.Body, 1.570796f, 0.0f, 0.0f);
		(this.LegL = new ModelRenderer(this, 40, 0)).addBox(-1.0f, -2.0f, -1.0f, 2, 10, 2);
		this.LegL.setRotationPoint(1.3f, 16.0f, 3.0f);
		this.LegL.setTextureSize(64, 32);
		this.LegL.mirror = true;
		this.setRotation(this.LegL, 0.0f, 0.0f, 0.0f);
		(this.LegR = new ModelRenderer(this, 40, 0)).addBox(-1.0f, -2.0f, -1.0f, 2, 10, 2);
		this.LegR.setRotationPoint(-1.3f, 16.0f, 3.0f);
		...
		this.BackLegL.setRotationPoint(1.2f, 18.0f, 14.0f);
		...
		this.BackLegR.setRotationPoint(-1.2f, 18.0f, 14.0f);
		...
		(this.HearL = new ModelRenderer(this, 0, 10)).addBox(-0.5f, -1.0f, -1.0f, 1, 1, 2);
		this.HearL.setRotationPoint(1.5f, 13.0f, -1.0f);
		this.HearL.setTextureSize(64, 32);
		this.HearL.mirror = true;
		this.setRotation(this.HearL, 0.0f, 0.0f, 0.0f);
		(this.HearR = new ModelRenderer(this, 6, 10)).addBox(-0.5f, -1.0f, -1.0f, 1, 1, 2);
		this.HearR.setRotationPoint(-1.5f, 13.0f, -1.0f);
