...
public class Key extends ModelBase {
	...
	public Key() {
		...
		(this.Shape2 = new ModelRenderer(this, 0, 16)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 1);
		this.Shape2.setRotationPoint(-0.5f, 22.0f, -3.0f);
		this.Shape2.setTextureSize(64, 32);
		this.Shape2.mirror = true;
		this.setRotation(this.Shape2, 0.0f, 0.0f, 0.0f);
		(this.Shape3 = new ModelRenderer(this, 0, 13)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 1);
		this.Shape3.setRotationPoint(-0.5f, 22.0f, -1.0f);
