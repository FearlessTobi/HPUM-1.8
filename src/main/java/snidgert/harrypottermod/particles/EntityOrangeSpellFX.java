...
public class EntityOrangeSpellFX extends EntityFX {
	...
	public EntityOrangeSpellFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
		...
		this.noClip = false;
		super.particleRed = 0.84705883f;
		super.particleGreen = 0.6666667f;
		super.particleBlue = 0.39215687f;
	}
	...
	public void onUpdate() {
		...
		if (this.field_92054_ax && super.particleAge < super.particleMaxAge / 2 && (super.particleAge + super.particleMaxAge) % 2 == 0) {
			final EntityOrangeSpellFX entityfireworksparkfx = new EntityOrangeSpellFX(this.worldObj, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0);
