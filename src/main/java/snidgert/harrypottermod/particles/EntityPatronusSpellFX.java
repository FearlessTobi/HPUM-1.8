...
public class EntityPatronusSpellFX extends EntityFX {
	...
	public EntityPatronusSpellFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
		...
		this.noClip = false;
		super.particleRed = 0.7137255f;
		super.particleGreen = 0.90588236f;
		super.particleBlue = 0.96862745f;
	}
	...
	public void onUpdate() {
		...
		if (this.field_92054_ax && super.particleAge < super.particleMaxAge / 2 && (super.particleAge + super.particleMaxAge) % 2 == 0) {
			final EntityPatronusSpellFX entityfireworksparkfx = new EntityPatronusSpellFX(this.worldObj, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0);
