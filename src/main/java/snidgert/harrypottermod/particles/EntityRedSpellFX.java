...
public class EntityRedSpellFX extends EntityFX {
	...
	public EntityRedSpellFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
		...
		this.noClip = false;
		super.particleRed = 0.9372549f;
		super.particleGreen = 0.43529412f;
		super.particleBlue = 0.43137255f;
	}
	...
	public void onUpdate() {
		...
		if (this.field_92054_ax && super.particleAge < super.particleMaxAge / 2 && (super.particleAge + super.particleMaxAge) % 2 == 0) {
			final EntityRedSpellFX entityfireworksparkfx = new EntityRedSpellFX(this.worldObj, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0);
