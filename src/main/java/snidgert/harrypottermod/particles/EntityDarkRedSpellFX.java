...
public class EntityDarkRedSpellFX extends EntityFX {
	...
	public EntityDarkRedSpellFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
		...
		super.particleGreen = 0.12941177f;
		super.particleBlue = 0.12941177f;
	}
	...
	public void onUpdate() {
		...
		if (this.field_92054_ax && super.particleAge < super.particleMaxAge / 2 && (super.particleAge + super.particleMaxAge) % 2 == 0) {
			final EntityDarkRedSpellFX entityfireworksparkfx = new EntityDarkRedSpellFX(this.worldObj, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0);
