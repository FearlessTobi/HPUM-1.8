...
public class EntityBlueSpellFX extends EntityFX {
	...
	public EntityBlueSpellFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
		...
		this.noClip = false;
		super.particleRed = 0.4627451f;
		super.particleGreen = 0.84705883f;
		super.particleBlue = 0.8509804f;
	}
	...
	public void onUpdate() {
		...
		if (this.field_92054_ax && super.particleAge < super.particleMaxAge / 2 && (super.particleAge + super.particleMaxAge) % 2 == 0) {
			final EntityBlueSpellFX entityfireworksparkfx = new EntityBlueSpellFX(this.worldObj, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0);
