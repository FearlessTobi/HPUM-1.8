...
public class EntityYellowSpellFX extends EntityFX {
	...
	public EntityYellowSpellFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
		...
		this.noClip = false;
		super.particleRed = 0.83137256f;
		super.particleGreen = 1.0f;
		super.particleBlue = 0.30980393f;
	}
	...
	public void onUpdate() {
		...
		if (this.field_92054_ax && super.particleAge < super.particleMaxAge / 2 && (super.particleAge + super.particleMaxAge) % 2 == 0) {
			final EntityYellowSpellFX entityfireworksparkfx = new EntityYellowSpellFX(this.worldObj, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0);
