...
public class EntityDarkBlueSpellFX extends EntityFX {
	...
	public EntityDarkBlueSpellFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
	...
	public void onUpdate() {
		...
		if (this.field_92054_ax && super.particleAge < super.particleMaxAge / 2 && (super.particleAge + super.particleMaxAge) % 2 == 0) {
			final EntityDarkBlueSpellFX entityfireworksparkfx = new EntityDarkBlueSpellFX(this.worldObj, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0);
