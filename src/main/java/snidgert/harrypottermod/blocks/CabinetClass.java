...
public class CabinetClass extends BlockContainer {
	...
	public boolean onBlockActivated(World par1World, BlockPos pos, IBlockState state, EntityPlayer par5EntityPlayer, EnumFacing side, float hitX, float hitY, float hitZ) {
		if (par5EntityPlayer.isSneaking()) {
			final BlockPos BlockPos = par5EntityPlayer.playerLocation;
			par5EntityPlayer.setSpawnChunk(pos, true, par5EntityPlayer.dimension);
		} else if (par5EntityPlayer.getBedLocation(par5EntityPlayer.dimension) != null) {
			final BlockPos BlockPos = par5EntityPlayer.playerLocation;
			for (int counter = 0; counter < 20; ++counter) {
				par5EntityPlayer.setPosition(par5EntityPlayer.getBedLocation(par5EntityPlayer.dimension).getX(), par5EntityPlayer.getBedLocation(par5EntityPlayer.dimension).getY(), par5EntityPlayer.getBedLocation(par5EntityPlayer.dimension).getZ());
			}
