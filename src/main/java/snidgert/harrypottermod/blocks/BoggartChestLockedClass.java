...
public class BoggartChestLockedClass extends BlockContainer {
	...
	private final String name = "BoggartChestLocked";
	...
	public boolean onBlockActivated(World par1World, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		par1World.setBlockState(pos, MainClass.BoggartChestOpen.getDefaultState());
		if (!par1World.isRemote) {
			final EntityBoggartDementor entityboat = new EntityBoggartDementor(par1World, pos.getX() + 0.5f, pos.getY() + 1.0f, pos.getZ() + 0.5f);
