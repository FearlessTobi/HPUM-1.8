...
public class DarkMarkClass extends BlockContainer {

	private final String name = "DarkMark";

	public DarkMarkClass(final Material arg0) {
		super(arg0);
	...
	public TileEntity createNewTileEntity(final World arg0, final int arg1) {
		return new TileEntityDarkMarkClass();
	}
