...
public class PensieveClass extends BlockContainer {

	private final String name = "Pensieve";

	public PensieveClass(final Material arg0) {
		super(arg0);
