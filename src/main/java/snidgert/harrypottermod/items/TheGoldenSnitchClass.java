...
public class TheGoldenSnitchClass extends Item {

	private final String name = "TheGoldenSnitch";

	public TheGoldenSnitchClass() {
	...
	public ItemStack onItemRightClick(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer) {
		final String s = EnumChatFormatting.getTextWithoutFormattingCodes(par1ItemStack.getDisplayName());
		if (s.equals("I Open At The Close")) {
			par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(MainClass.RStone));
		}
		final float f = 1.0f;
		...
		if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
			...
			final EntityGoldenSnitch entityboat = new EntityGoldenSnitch(par2World, i + 0.5f, j + 1.0f, k + 0.5f);
