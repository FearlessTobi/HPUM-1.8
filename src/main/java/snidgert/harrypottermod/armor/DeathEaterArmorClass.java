...
public class DeathEaterArmorClass extends ItemArmor {

	public DeathEaterArmorClass(final ItemArmor.ArmorMaterial material, final int renderIndex, final int type) {
	...
	public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String layer) {
		return "harrypottermod:textures/models/armor/DeathEaterArmor.png";
	}
}
