...
public class SupportWandClass extends Item {
	...
	private final String name = "SupportWandClass";

	public SupportWandClass() {
		...
		if (!SupportWandClass.Support) {
			Label_11551: {
				...
				case 10: {
					...
					int m = movingobjectposition.getBlockPos().getX();
					int j4 = movingobjectposition.getBlockPos().getY();
					final int k3 = movingobjectposition.getBlockPos().getZ();
					if (world.getBlockState(new BlockPos(m, j4, k3)).getBlock() == Blocks.snow_layer) {
						--j4;
					}
					final EntityBird entityboat = new EntityBird(world, m + 0.5f, j4 + 1.0f, k3 + 0.5f);
				...
				case 11: {
					...
					final EntitySnake entityboat2 = new EntitySnake(world, m + 0.5f, j4 + 1.0f, k3 + 0.5f);
					((Entity) entityboat2).rotationYaw = ((MathHelper.floor_double(((Entity) entityplayer).rotationYaw * 4.0f / 360.0f + 0.5) & 0x3) - 1) * 90;
					entityboat2.setOwnerId(entityplayer.getUniqueID().toString());
					entityboat2.setTamed(true);
				...
				case 12: {
					if (this.getDamage(itemstack) == 12 && !world.isRemote) {
						...
						world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
						final List list1 = world.getEntitiesWithinAABB(EntityLivingBase.class, new AxisAlignedBB(((Entity) entityplayer).posX, ((Entity) entityplayer).posY, ((Entity) entityplayer).posZ, ((Entity) entityplayer).posX + 1.0, ((Entity) entityplayer).posY + 1.0, ((Entity) entityplayer).posZ + 1.0).expand(10.0, 5.0, 10.0));
						for (int j = 0; j < list1.size(); ++j) {
							final EntityLivingBase entityitem3 = (EntityLivingBase) list1.get(j);
							if (entityitem3 != null) {
								entityitem3.curePotionEffects(new ItemStack(Items.milk_bucket));
				...
				case 13: {
					...
					final double d7 = Item.itemRand.nextGaussian() * 0.02;
					world.spawnParticle(EnumParticleTypes.HEART, ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, ((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d5, d6, d7);
					world.spawnParticle(EnumParticleTypes.HEART, ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, ((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d5, d6, d7);
					world.spawnParticle(EnumParticleTypes.HEART, ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, ((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d5, d6, d7);
					world.spawnParticle(EnumParticleTypes.HEART, ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, ((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d5, d6, d7);
					world.spawnParticle(EnumParticleTypes.HEART, ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, ((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d5, d6, d7);
					entityplayer.heal(30.0f);
					entityplayer.addPotionEffect(new PotionEffect(Potion.heal.id, 1, 2));

					if (!world.isRemote) {
						final List list3 = world.getEntitiesWithinAABB(EntityLivingBase.class, new AxisAlignedBB(((Entity) entityplayer).posX, ((Entity) entityplayer).posY, ((Entity) entityplayer).posZ, ((Entity) entityplayer).posX + 1.0, ((Entity) entityplayer).posY + 1.0, ((Entity) entityplayer).posZ + 1.0).expand(10.0, 5.0, 10.0));
						for (int j5 = 0; j5 < list3.size(); ++j5) {
							final EntityLivingBase entityitem4 = (EntityLivingBase) list3.get(j5);
							if (entityitem4 != null) {
								entityitem4.heal(30.0f);
								entityitem4.addPotionEffect(new PotionEffect(Potion.heal.id, 1, 2));
				...
				case 14: {
					if (this.getDamage(itemstack) == 14 && !world.isRemote) {
						world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
						entityplayer.setInvisible(true);
						((Entity) entityplayer).noClip = true;
						final EntityCatForm entitylevitate = new EntityCatForm(world);
				...
				case 15: {
					if (this.getDamage(itemstack) == 15 && !world.isRemote) {
						world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
						entityplayer.setInvisible(true);
						((Entity) entityplayer).noClip = true;
						final EntityOwlForm entitylevitate2 = new EntityOwlForm(world);
				...
				case 16: {
					if (this.getDamage(itemstack) == 16 && !world.isRemote) {
						world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
						entityplayer.setInvisible(true);
						((Entity) entityplayer).noClip = true;
						final EntityPhoenixForm entitylevitate3 = new EntityPhoenixForm(world);
	...
	public void onPlayerStoppedUsing(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer, final int par4) {
		...
		if (this.getDamage(par1ItemStack) == 18 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final ConfundoStrongProjectile fireball3 = new ConfundoStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 19 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final StunStrongProjectile fireball4 = new StunStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 20 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final PatronusStrongProjectile fireball5 = new PatronusStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 21 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final ImperioProjectile fireball6 = new ImperioProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 22 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final CrucioProjectile fireball7 = new CrucioProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 23 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final AvadakedavraProjectile fireball8 = new AvadakedavraProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
	...
	public void onUpdate(final ItemStack par1ItemStack, final World par2World, final Entity par3Entity, final int par4, final boolean par5) {
		...
		if (!par2World.isRemote && par3Entity instanceof EntityPlayer && par1ItemStack == ((EntityPlayer) par3Entity).getHeldItem()) {
			...
			if (this.Quick4) {
				this.setDamage(par1ItemStack, 13);
				this.Quick4 = false;
			}
			if (this.Quick5) {
				this.setDamage(par1ItemStack, 12);
				this.Quick5 = false;
			}
			if (this.Quick6) {
