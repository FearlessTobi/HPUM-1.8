...
public class ElderWandClass extends WoodWandClass {

	private final String name = "ElderWand";
		...
		Label_33472: {
			...
			case 2: {
				if (this.getDamage(itemstack) == 2) {
					world.playSoundEffect(((Entity) entityplayer).posX + 0.2, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
			...
			case 6: {
				...
				final int k3 = (int) ((Entity) entityplayer).posY;
				...
				if (world.getBlockState(new BlockPos(j2 + 2, k3, l2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 2, k3, l2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 - 1, k3, l2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 - 1, k3, l2), Blocks.ice.getDefaultState());
				...
				if (world.getBlockState(new BlockPos(j2, k3, l2 - 2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2, k3, l2 - 2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2, k3, l2 + 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2, k3, l2 + 1), Blocks.ice.getDefaultState());
				...
				if (world.getBlockState(new BlockPos(j2 + 2, k3, l2 - 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 2, k3, l2 - 1), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 - 1, k3, l2 - 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 - 1, k3, l2 - 1), Blocks.ice.getDefaultState());
				...
				if (world.getBlockState(new BlockPos(j2 - 1, k3, l2 - 2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 - 1, k3, l2 - 2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 + 1, k3, l2 + 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 1, k3, l2 + 1), Blocks.ice.getDefaultState());
				...
				if (world.getBlockState(new BlockPos(j2 - 2, k3, l2 - 2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 - 2, k3, l2 - 2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 + 2, k3, l2 - 2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 2, k3, l2 - 2), Blocks.ice.getDefaultState());
				...
				if (world.getBlockState(new BlockPos(j2, k3 - 1, l2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2, k3 - 1, l2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 + 1, k3 - 1, l2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 1, k3 - 1, l2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 + 2, k3 - 1, l2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 2, k3 - 1, l2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 - 1, k3 - 1, l2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 - 1, k3 - 1, l2), Blocks.ice.getDefaultState());
				...
				if (world.getBlockState(new BlockPos(j2, k3 - 1, l2 - 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2, k3 - 1, l2 - 1), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2, k3 - 1, l2 - 2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2, k3 - 1, l2 - 2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2, k3 - 1, l2 + 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2, k3 - 1, l2 + 1), Blocks.ice.getDefaultState());
				...
				if (world.getBlockState(new BlockPos(j2 + 1, k3 - 1, l2 - 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 1, k3 - 1, l2 - 1), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 + 2, k3 - 1, l2 - 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 2, k3 - 1, l2 - 1), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 - 1, k3 - 1, l2 - 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 - 1, k3 - 1, l2 - 1), Blocks.ice.getDefaultState());
				...
				if (world.getBlockState(new BlockPos(j2 - 1, k3 - 1, l2 - 2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 - 1, k3 - 1, l2 - 2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 + 1, k3 - 1, l2 + 1)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 1, k3 - 1, l2 + 1), Blocks.ice.getDefaultState());
				...
				if (world.getBlockState(new BlockPos(j2 - 2, k3 - 1, l2 - 2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 - 2, k3 - 1, l2 - 2), Blocks.ice.getDefaultState());
					world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
				}
				if (world.getBlockState(new BlockPos(j2 + 2, k3 - 1, l2 - 2)).getBlock() == Blocks.water) {
					world.setBlockState(new BlockPos(j2 + 2, k3 - 1, l2 - 2), Blocks.ice.getDefaultState());
	...
	public void onPlayerStoppedUsing(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer, final int par4) {
		...
		if (this.getDamage(par1ItemStack) == 16 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final ReductoStrongProjectile fireball3 = new ReductoStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 18 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final StunStrongProjectile fireball5 = new StunStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 19 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final LevicorpusStrongProjectile fireball6 = new LevicorpusStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 20 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final ConfringoStrongProjectile fireball7 = new ConfringoStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 22 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final SectumsempraStrongProjectile fireball8 = new SectumsempraStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 23 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final StupefyStrongProjectile fireball9 = new StupefyStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 24 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final ExpelliarmusStrongProjectile fireball10 = new ExpelliarmusStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 25 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final PatronusStrongProjectile fireball11 = new PatronusStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 27 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final CrucioStrongProjectile fireball13 = new CrucioStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
		...
		if (this.getDamage(par1ItemStack) == 29 && !par2World.isRemote) {
			final Vec3 look = par3EntityPlayer.getLookVec();
			final ConfundoStrongProjectile fireball15 = new ConfundoStrongProjectile(par2World, par3EntityPlayer, 1.0, 1.0, 1.0);
