...
public class ReductoStrongProjectile extends MagicProjectile {

	public int field_92057_e;

	public ReductoStrongProjectile(final World par1World) {
		super(par1World);
		this.field_92057_e = 3;
		this.setSize(0.5f, 0.5f);
	}

	public ReductoStrongProjectile(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
		super(par1World, par2, par4, par6, par8, par10, par12);
		this.field_92057_e = 3;
	}

	public ReductoStrongProjectile(final World par1World, final EntityLivingBase par2EntityLivingBase, final double par3, final double par5, final double par7) {
	...
	protected void onImpact(final MovingObjectPosition par1MovingObjectPosition) {
		if (!super.worldObj.isRemote) {
			if (par1MovingObjectPosition.entityHit != null && par1MovingObjectPosition.entityHit instanceof EntityLivingBase && par1MovingObjectPosition.entityHit instanceof EntityLivingBase) {
				if (((EntityLivingBase) par1MovingObjectPosition.entityHit).isPotionActive(MainClass.ShieldEffect)) {
					...
					par1MovingObjectPosition.entityHit.attackEntityFrom(DamageSource.magic, 18.0f);
				}
			}
